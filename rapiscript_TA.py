...
control_board['filename'] = 'final_TAfig5a'
...
control_board['filename'] = 'final_TAfig5b'
...
######################################################################
control_board['title'] = 'Empirical 2.5%, 97.5% Quantiles for Satisfaction Model'

control_board['filename'] = 'final_sensitivity2'
...
######################################################################
control_board['title'] = '95% Confidence Interval for Satisfaction Model'

control_board['filename'] = 'final_sensitivity1'
