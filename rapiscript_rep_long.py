...
control_board['filename'] = 'replicator_long_med_500'

parameters['phi'] = ap.Values(4.0,4.5,5,5.5)

compare_two(parameters, control_board)

#######################################################

control_board['filename'] - 'replicator_long_high_500'
