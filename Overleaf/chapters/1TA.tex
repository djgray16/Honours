...
The BA graph induces cooperation for a lower enhancement factor $r$. The WS graph generally has the lowest cooperation. Interestingly, the TAG graph should be similar to the BA graph, because, for $\alpha = 0.3$, $30\%$ of the nodes are added in BA style. This is not observed in the results for this range of $r$. \\
\FloatBarrier
\graphCap{graphs1.png}{0.8}{Testing}{graphs1}
\FloatBarrier
