...
for gmodel in gmodels:
    filename = 'Rep_graph_m_low_superlong'+gmodel
    ...
    control_board['filename'] = 'Rep_graph_m_med_superlong'+gmodel
    ...
    control_board['filename'] = 'Rep_graph_m_high_superlong'+gmodel
