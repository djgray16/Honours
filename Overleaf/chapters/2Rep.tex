...
\FloatBarrier
\graphCap{lotteryp4_me_quantiles_empirical.png}{1}{Empirical 2.5\%, 97.5\% Quantiles of Imitation Dynamics Lottery Game, $p=0.4$, T = 120. The strategies SS, RR, SR, RS, R--WR, R--WS are represented by blue circles, orange stars, green crosses, red pentagons, brown diamonds, and purple squares respectively. The quantile for each series is is the dashed line. }{lottery_quantiles_empirical}
\FloatBarrier

\FloatBarrier
\graphCap{lotteryp4_me_quantiles.png}{1}{Empirical 2.5\%, 97.5\% Quantiles of Imitation Dynamics Lottery Game, $p=0.4$, T = 120. The strategies SS, RR, SR, RS, R--WR, R--WS are represented by blue circles, orange stars, green crosses, red pentagons, brown diamonds, and purple squares respectively. The quantile for each series is is the dashed line. }{lottery_quantiles}
\FloatBarrier
Figure \ref{lottery_quantiles} extends the number of generations to 1000, to fully investigate the dynamics. 
